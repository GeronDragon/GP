...
//#if EXTERNAL_INTERRUPT_SELECT == 0   //打开外部中断1--由外部1ms定时信号驱动
	...
	XIntruptRegs.XINT1CR.all=0x1;//打开管脚xint1外中断，默认是下降沿触发中断，如为上升沿，则0x5
//#endif
...
//#endif
	...
	//********************************全局中断使能
   //EINT;   // Enable Global interrupt INTM           	//l.r. 20150505先不开
   //ERTM;   // Enable Global realtime interrupt DBGM	//l.r. 20150505先不开
}
